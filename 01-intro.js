...
//const, que no permite la modificacion de la variable
const pi = 3.1415;
...
//let es mutable, puede cambiar su tipo de valor solo modificando el valor que tiene
edad = "treinta y uno";

//Para saber que tipo de valor es usamos typeof
...
//nulo; algo debería estar ahí pero no está
let nulo = null;

console.log(nulo);

console.log(25 / "pollos"); //No se sabe que tipo de dato es, por eso sale NaN
...
//push para agregar elemento al final
nombresAlumnos.push("Klebert");

console.log(nombresAlumnos);

//pop para quitar elemento del final
nombresAlumnos.pop();
...
let mascota = {
    ...
    //ladrar: function () {
    //    console.log(this); THIS hace referencia al objeto mascota
    //    console.log("arf!");
    //},

    //Window hac referencia al navegador
    ladrar: () => {
        console.log(this); //THIS hace referencia al objeto window por el simbolo '() =>'
        console.log("arf!");
    },
}
...
//Una de las ventajas de '() =>' es que puedo reducir el objeto a una linea
//let saludar = () => "Hola";
//Si no se ingresa ningun argumento, el texto por defecto será "Hola!!!"
...
//dos == estan comparando el contenido
console.log("solo con dos= ", 1 == "1");

//=== estoy comparando el cotenido y el tipo de dato
...
//Funcion que determina cual de los 3 parametros es mayor
...
console.log( "El numero mayor es: " + mayor(10, 15, 6));
...
if((num_m % 5) == 0) {
    console.log("El número " + num_m + " si es multiplo de 5");
}
*/

//Funcion que muestra los primeros 50 multiplos de 7, pero no multiplos de 2, 3 o 5
function multiplo() {

    var cont = 0;
    var num = 0;

    for (num=0; cont<=50; num++) {

        if( (num%7 == 0) && (num%2 != 0) && (num%3 != 0) && (num%5 != 0) ) {
            console.log(num)
            cont = cont +1;
        }
    }
...
//Funcion que calcula la comision sobre las ventas totales de un empleado
function comision_ventas(precio_ventas) {

    var comision = 0;

    if (precio_ventas <= 150) {
        console.log("Este empleado no recibe comisión");
    
    } else if (precio_ventas > 150 && precio_ventas <= 400 ) {
        comision = precio_ventas * 0.1;
        console.log("Este empleado recibe una comisión de S/." + comision);

    } else if (precio_ventas > 400) {
        comision = (precio_ventas * 0.09) + 50;
        console.log("Este empleado no recibe comisión de S/." + comision);

    } else {
        console.log("Precio errado")
    }
...
//Funcion que retorna las peliculas en idioma ingles
function peliculas_en() {
...
function desplazar(j) {
    ...
    //Ejem. Los numeros a desplazar son 2, itera 2 veces, 0 y 1
    for (let i = 0; i < j; i++) {

        //push añade el primer elemento del array al final
        enteros.push(enteros[0]);
